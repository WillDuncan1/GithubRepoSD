...
void TMR1_Initialize(void) {
    //TSIDL disabled; TGATE disabled; TCS FOSC/2; TSYNC disabled; TCKPS 1:8; TECS SOSC; TON enabled; 
    T1CON = 0x8010;
    //TMR1 0; 
    TMR1 = 0x0000;
    //Period Value = 20.000 ms; PR1 10000; 
    PR1 = 0x2710;
...
extern int TimerVariable;
void TMR1_CallBack(void) {
    // Add your custom callback code here
    TimerVariable++;                            //Increments every .1 second 
