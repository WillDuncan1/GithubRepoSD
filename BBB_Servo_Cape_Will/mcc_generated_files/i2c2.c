...
void I2C2_Initialize(void) {
    ...
    // RCEN disabled; A10M 7 Bit; RSEN disabled; STRICT disabled; ACKEN disabled; DISSLW disabled; SCLREL Holds; SEN disabled; ACKDT Sends ACK; GCEN disabled; SMEN disabled; PEN disabled; I2CEN enabled; I2CSIDL disabled; STREN disabled; 
    I2C2CONL = 0x8000;
    // P disabled; IWCOL disabled; S disabled; R_nW disabled; I2COV disabled; BCL disabled; D_nA disabled; 
    I2C2STAT = 0x0000;
    // ADD 16; 
