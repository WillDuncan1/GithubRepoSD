...
void I2C2_Initialize(void) {
    ...
    // RCEN disabled; A10M 7 Bit; RSEN disabled; ACKEN disabled; DISSLW enabled; SCLREL Holds; SEN disabled; ACKDT Sends ACK; GCEN disabled; SMEN disabled; PEN disabled; I2CEN enabled; I2CSIDL disabled; STREN disabled; IPMIEN disabled; 
    I2C2CON = 0x8000;
