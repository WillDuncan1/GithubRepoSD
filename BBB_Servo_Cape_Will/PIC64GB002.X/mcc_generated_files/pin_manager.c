...
void PIN_MANAGER_Initialize(void) {
    ...
    RPOR5bits.RP10R = 0x16; // RB10->OC5:OC5
    RPOR5bits.RP11R = 0x15; // RB11->OC4:OC4
    RPOR6bits.RP13R = 0x14; // RB13->OC3:OC3
    RPOR7bits.RP14R = 0x13; // RB14->OC2:OC2
    RPOR7bits.RP15R = 0x12; // RB15->OC1:OC1
